...
impl<P: ExtractSymbol> ExtractSymbol for BasicFixity<P> {
...
impl<P: ExtractSymbol> ExtractSymbol for InfixPrimary<P> {
...
impl<P: ExtractSymbol> ExtractSymbol for InfixApply<P> {
...
impl<P: ExtractSymbol> ExtractSymbol for PrefixApply<P> {
