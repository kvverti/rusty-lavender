...
mod tests {
    ...
    fn parses() {
                ...
                InfixPrimary::Primary(ValuePrimary::SubExpression(Box::new(
                    ValueExpression::Application(BasicFixity::Infix(InfixApply {
                        ...
                        args: vec![
                            ...
                            InfixPrimary::Primary(ValuePrimary::Literal(Literal::Int(IntLiteral(
                                3,
                            )))),
                        ],
                    })),
        ...
        assert!(
            result.is_ok(),
            format!("Expected ok expression parse, got {:?}", result)
        );
    ...
    fn expr_with_lambda() {
        ...
        let expected = ValueExpression::Application(BasicFixity::Infix(InfixApply {
            ...
            args: vec![
                ...
                InfixPrimary::Primary(ValuePrimary::SubExpression(Box::new(
                    ValueExpression::Lambda(LambdaExpression::Value {
                        ...
                        body: Box::new(ValueExpression::Application(BasicFixity::Prefix(
                            PrefixApply {
